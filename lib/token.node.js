(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fast-sha256"), require("supercop.js"), require("bytebuffer"), require("fs"), require("path"), require("es6-promise"), require("axios"));
	else if(typeof define === 'function' && define.amd)
		define("token.node", ["fast-sha256", "supercop.js", "bytebuffer", "fs", "path", "es6-promise", "axios"], factory);
	else if(typeof exports === 'object')
		exports["token.node"] = factory(require("fast-sha256"), require("supercop.js"), require("bytebuffer"), require("fs"), require("path"), require("es6-promise"), require("axios"));
	else
		root["token.node"] = factory(root["fast-sha256"], root["supercop.js"], root["bytebuffer"], root["fs"], root["path"], root["es6-promise"], root["axios"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_18__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Token = {
	  ...
	  login: function login(memberId, key) {}
	};
	...
	var TokenIO = function () {
	  ...
	  _createClass(TokenIO, null, [{
	    ...
	    value: function createMember(alias) {
	      ...
	      return _HttpClient2.default.createMemberId().then(function (response) {
	        _HttpClient2.default.addFirstKey(keys, response.data.memberId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.strKey = exports.sign = exports.generateKeys = undefined;

	var _fastSha = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var pad_string_1 = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var protoDefinition = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./proto/gateway.proto\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	console.log("Def", protoDefinition);
	console.log("Loader", ProtoBuf.loadJson(protoDefinition));
	  ...
	  _createClass(HttpClient, null, [{
	    ...
	    value: function addFirstKey(keys, memberId) {
	      ...
	      var update = {
	        ...
	        member_id: memberId,
	        operation: {
	          publicKey: (0, _Crypto.strKey)(keys.publicKey),
	          level: level,
	          tags: tags
	        }
	      };
	      var req = {
	        ...
	        signature: {
	          key_id: keys.keyId,
	          signature: (0, _Crypto.sign)(JSON.stringify(update), keys),
	          timestamp: new Date().getTime()
	        }
	      };
	      console.log("JSON: ", JSON.stringify(req));
	      var reqProto = ProtoBuf.loadJson(JSON.stringify(req));
	      console.log("Req proto is:", reqProto);
	      console.log("Req is:", reqProto.toString());
	      return instance({
	        method: "post",
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(global, factory) {
	    ...
	    /* AMD */ if ("function" === 'function' && __webpack_require__(12)["amd"])
	    ...
	    /* CommonJS */ else if ("function" === "function" && typeof module === "object" && module && module["exports"])
	        module["exports"] = factory(__webpack_require__(13), true);
	    /* Global */ else
